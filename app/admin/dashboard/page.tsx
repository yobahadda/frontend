...
import { GraduationCap, BookOpen, Users, ClipboardList, UserCheck, Settings, BarChart2 } from 'lucide-react'
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-6">
      ...
      <Card className="w-full max-w-7xl mx-auto bg-white/80 backdrop-blur-lg shadow-xl rounded-xl overflow-hidden">
        <CardContent className="p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid grid-cols-4 lg:grid-cols-8 gap-4 bg-gray-100 p-2 rounded-lg">
